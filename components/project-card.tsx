      ...
      >
        ...
        >
          ...
          <div className="absolute left-4 top-4 flex items-center gap-2">
            <span className="rounded-full border border-black/10 bg-white/60 px-3 py-1 text-[11px] font-medium tracking-wide text-foreground/80 backdrop-blur-sm">
              {categoryLabels[project.category]}
            </span>
          </div>
          <span className="absolute right-4 top-4 font-mono text-xs text-black/40">
            {project.year}
          </span>

          {/* Ghost index numeral */}
          <span
            className="pointer-events-none absolute -bottom-4 left-4 select-none text-[7rem] leading-none text-black/10 transition-colors duration-500 group-hover:text-black/20"
          ...
          {/* Arrow bubble */}
          <div className="absolute bottom-4 right-4 flex h-10 w-10 items-center justify-center rounded-full border border-black/10 bg-white/60 backdrop-blur-sm transition-all duration-500 group-hover:bg-[#3b0dd4]">
            <ArrowUpRight className="h-4 w-4 text-[#3b0dd4] transition-all duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-white" />
          </div>
        </div>
