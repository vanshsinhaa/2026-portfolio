...
export function MagneticText({ text = "CREATIVE", hoverText = "EXPLORE", className, textClassName, style }: MagneticTextProps) {
  ...
  return (
    ...
    >
      ...
      <span className={cn("text-5xl font-bold tracking-tighter text-white", textClassName)} style={style}>{text}</span>
      ...
      >
        ...
        >
          <span className={cn("text-5xl font-bold tracking-tighter text-black whitespace-nowrap", textClassName)} style={style}>
            {hoverText}
          </span>
        </div>
      </div>
